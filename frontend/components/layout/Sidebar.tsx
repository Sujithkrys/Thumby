      ...
      <div className={`flex items-center mb-[18px] w-full ${isExpanded ? "justify-between px-[6px] py-1" : "justify-center"}`}>
        ...
        {isExpanded && (
          <button 
            ...
            className="border-none bg-transparent cursor-pointer text-slate hover:text-ink flex items-center justify-center p-[4px] rounded-[8px] hover:bg-studio transition-colors"
